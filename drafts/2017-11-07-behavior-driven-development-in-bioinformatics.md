...
## TL;DR
**Behavior-Driven Development (BDD)** is a process that emerged from test-driven software development. It is used by Europe PMC and widely used by many other organizations, and has become popular due to its transparency and the readability of the application behaviour.
